...
#include "wolf_unitree_interface/unitree_ros_control.hpp"


namespace unitree2ros {


UnitreeROSControl::UnitreeROSControl()
{
...
void UnitreeROSControl::init()
{
    ROS_INFO_NAMED(CLASS_NAME,"Initializing UnitreeROSControl");

	// Reset RobotHW
	robot_hw_.reset(new unitree2ros::UnitreeRobotHw);
...
void UnitreeROSControl::update(const ros::Time& time, const ros::Duration& period)
{
